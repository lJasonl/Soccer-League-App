...
class ScholarshipDataService {
  static List<ScholarshipFamily> families = [];

  static Future<void> loadFamilies() async {
    final box =
  ...
  static Future<void> saveFamilies() async {
    final box =
        StorageService.getScholarshipsBox();
  ...
  static Future<void> deleteFamily(
    String familyId,
  ) async {
  ...
  static ScholarshipFamily? getFamily(
    String familyId,
  ) {
    try {
